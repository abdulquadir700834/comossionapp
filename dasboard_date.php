...
// Add header row
$headerRow = ['EVENT','FIRSTNAME','Hub-FIRSTNAME','LASTNAME','HUB-LASTNAME','DID','HUB-DID', 'EMAIL','HUB-EMAIL', 'DE','HUB-DE','JOB TITLE','HUB-JOB TITLE','ORGANISATION','HUB-ORGANISATION','STREET ADDRESS','HUB-STREET ADDRESS',  'CITY','HUB-CITY', 'COUNTRY','HUB-COUNTRY', 'POSTAL CODE','HUB-POSTAL CODE', 'MOBILE NUMBER','HUB-MOBILE NUMBER'];
...
FROM qr_attendance_history LEFT JOIN cm_hubspot on (qr_attendance_history.event_id = cm_hubspot.event_id AND qr_attendance_history.email = cm_hubspot.email) $search";
