...
-->
                ...
                <div class="col-md-2">
                  ...
                  <input type="text" placeholder="DELEGATES" name="de" id="txtDelegetas" class="form-control typeahead">
                </div>
                <div class="col-md-2">
                  <label>EVENT</label>
                  <select class="form-control eventdh" name="event">
                    ...
                    while ( $RowQrEvent = mysqli_fetch_array( $QrEventData ) ) {
                      ?>
                    <option value="<?php echo $RowQrEvent['ID'];?>"><?php echo $RowQrEvent['EVENT_TITLE'];?></option>
                    <?php } ?>
                  </select>
                </div>
                <div class="col-md-4">
          ...
          <div class="col-md-2">
            <form action="dasboard_date.php" method="post">
              ...
              <button type="submit" class="btn btn-orange" style="float: right; margin-right: 10px; background-color: #fb8c00; font-size: 12px; margin-top: 17px; line-height: 1.1"><span style="font-size: 15px;">Download</span><br>Mismatch Report</button>
            </form>
          </div>
        </div>
      </div>
